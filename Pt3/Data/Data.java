...
public class Data {
    ...
    public Data(int dia, int mes, int any) {
        ...
        if (mes < 1 || mes > 12) {
            System.out.println("Error: el mes no puede ser inferior a 1 o superior a 12");
            return;
        }

        // Valida el día introducido
        if (dia < 1 || dia > getMaxDiasDelMes(mes, any)) {
            System.out.println("Error: el día no es válido para el mes " + mes);
            return;
        }
    ...
    public void setDia(int dia) {
        ...
        if (dia < 1 || dia > getMaxDiasDelMes(mes, any)) {
            System.out.println("Error: el día " + dia + " no es válido para el mes " + mes);
        } else {
            this.dia = dia;
        }
    }
